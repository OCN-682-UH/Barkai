...
#Saving my plot 
ggsave(here("Week_08","Output","Badplot.pdf"), plot = bad_plot, width = 8, height = 6) #saving my plot to the output folder
...
ggsave(here("Week_08","Output","Goodplot.pdf"), plot = good_plot, width = 8, height = 6) #save plot
